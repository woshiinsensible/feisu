			...
			<div class="row">
				...
				<div class="span10">
					<form id="edit-profile" class="form-horizontal">
						<fieldset>
							<legend>修改组合账号</legend>
							<div class="control-group">
								<label class="control-label" for="input01">ID</label>
								<div class="controls">
									<input type="text" class="input-xlarge" id="b_id" name="b_id" value="{{$data[0]->b_id}}" readonly>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="input01">账号</label>
								<div class="controls">
									<input type="text" class="input-xlarge" id="b_user" name="b_user" value="{{$data[0]->b_user}}">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="input01">密码</label>
								<div class="controls">
									<input type="text" class="input-xlarge" id="b_pwd" name="b_pwd" value="{{$data[0]->b_pwd}}">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<select name="sel1" id="sel1">
										@forelse ($zoneData as $v)
											@if ($v->z_short == $data[0]->b_terminal)
												<option id="b_terminal" value="{{$v->z_short}}" selected>{{$v->z_short}}</option>
											@else
							...
							<div class="control-group">
								...
								<div class="controls">
									<select name="sel1" id="sel1">
										@forelse ($zoneData as $v)
											@if ($v->z_name == $data[0]->b_zone)
												<option id="b_zone" value="{{$v->z_name}}" selected>{{$v->z_name}}</option>
											@else
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="input-xlarge" id="b_group" name="b_group" value="{{$data[0]->b_group}}" style="width:750px">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="input01">备注</label>
								<div class="controls">
									<input type="text" class="input-xlarge" id="b_com" name="b_com" value="{{$data[0]->b_com}}">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="input01">价格</label>
								<div class="controls">
									<input type="number" class="input-xlarge" id="b_price" name="b_price" value="{{$data[0]->b_price}}">
								</div>
							</div>
